...
import { FaEnvelope, FaLinkedin, FaTwitter, FaGithub, FaCalendarAlt } from "react-icons/fa";
...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      setFormStatus({ status: "success", message: "Message sent successfully! I'll get back to you soon." });
      setFormData({
        name: "",
        email: "",
        subject: "",
        ...
        <div className={styles.contactContent}>
          <div className={styles.contactInfo}>
            <div className={styles.infoCard}>
              ...
              <h3>Email</h3>
              <p>arkalalchakravarty@gmail.com</p>
              <a href="mailto:arkalalchakravarty@gmail.com" className={styles.contactButton}>
                Send Email
              </a>
            </div>
